...
/**
 * Ghost class represents a ghost character in a Pacman game.
 * Ghost moves autonomously within the maze and interacts with the player.
 */
public class Ghost extends Rectangle implements Runnable {

    /**
     * Direction in which the Ghost is currently moving.
     */
    String direction;

    /**
     * Reference to the Manager class to check for collisions.
     */
    Manager manager;

    /**
     * Reference to the Maze in which the Ghost moves.
     */
    Maze maze;

    /**
     * AnimationTimer object controlling the Ghost's movement.
     */
    AnimationTimer animation;

    /**
     * Counter for the number of steps the Ghost has taken.
     */
    int timesWalked;

    /**
     * Ghost constructor. Initialises a Ghost instance with given parameters.
     *
    ...
    public Ghost(double x, double y, Color color, Maze maze, Manager manager) {
        // Set the x-coordinate of the Ghost
        this.setX(x);
        // Set the y-coordinate of the Ghost
        this.setY(y);
        // Assign the Maze object
        this.maze = maze;
        // Assign the Manager object
        this.manager = manager;
        // Set the height of the Ghost
        this.setHeight(50);
        // Set the width of the Ghost
        this.setWidth(50);
        ...
        this.direction = "down";
        // Create the movement animation for the Ghost
    ...
    /**
     * Returns the AnimationTimer instance that controls the Ghost's movement.
     *
     * @return AnimationTimer The animation timer of the Ghost
     */
    public AnimationTimer getAnimation() {
        // Return the animation timer controlling the Ghost's movement
        return animation;
    }
    ...
    private void checkIfTheresPathToGo(String direction) {
        ...
        switch (direction) {
            ...
            case "up":
                ...
                rightEdge = getX() + getWidth() + 10;
                topEdge = getY() - 15;
                // If there's no obstacle, set the Ghost's direction to up
            ...
            case "left":
                ...
                topEdge = getY() - 10;
                // If there's no obstacle, set the Ghost's direction to left
            ...
            case "right":
                ...
                topEdge = getY() - 10;
                // If there's no obstacle, set the Ghost's direction to right
    ...
    /**
     * Moves the Ghost in the provided direction until it can't move further.
     *
    ...
    /**
     * Creates an animation for the Ghost's movement.
     */
    ...
    /**
     * Starts the animation timer for the Ghost's movement.
     */
    @Override
    public void run() {
