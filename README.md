...
```
cd existing_repo
git remote add origin https://projects.cs.nott.ac.uk/psyes9/comp2013_reassessment.git
git branch -M main
...
- [ ] [Set up project integrations](https://projects.cs.nott.ac.uk/psyes9/comp2013_reassessment/-/settings/integrations)
